...
<div className='form-control'>
  ...
  <div className="form-control">
<h5>Company</h5>
<select name="company" valuue={company} onChange={updateFilters} className="company">
...
<div className="colors">
  {
    colors.map((c,index)=>{
      if(c==='all'){
        return <button key={ index} ame="color" onClick={updateFilters} data-color='all' className={`${color==='all'?'all btn-active':'all-btn'}`}>
          all
        </button>
      }
